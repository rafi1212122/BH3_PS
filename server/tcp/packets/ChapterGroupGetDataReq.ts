...
import ChapterGroupConfig from "../../../utils/excel/ChapterGroupConfig";
...
export default async (session: Session, packet: Packet) => {
	...
	const rsp = Packet.encode(ChapterGroupGetDataRsp, {
        ...
        chapterGroupList: ChapterGroupConfig.all().map(chapterGroup => ({
          id: chapterGroup.ID,
          siteList: chapterGroup.SiteList.map(site => ({
              siteId: site,
              chapterId: site,
              status: 3
          }))
